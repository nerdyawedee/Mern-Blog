...
'Authorization': `Bearer ${currentUser.token}`,        }
  ...
  return (
    <div className='table-auto overflow-x-scroll md:mx-auto p-3 scrollbar dark:text-white scrollbar-track-slate-100 scrollbar-thumb-slate-300 dark:scrollbar-track-slate-700 dark:scrollbar-thumb-slate-500'>
